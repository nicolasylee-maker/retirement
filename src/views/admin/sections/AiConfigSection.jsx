...
const PROMPT_FIELDS = [
  ...
  { key: 'prompt_dashboard', label: 'Dashboard Prompt', variables: '{currentAge}, {retirementAge}, {lifeExpectancy}, {inflationRatePct}, {monthlyExpenses}, {expReductionPct}, {expensesAtRetirement}, {expensesMonthlyToday}, {portfolioAtRetirement}, {netWorthAtRetirement}, {annualIncome}, {annualTax}, {annualShortfall}, {shortfallMonthlyToday}, {sustainableMonthly}, {sustainableMonthlyToday}, {portfolioAtEnd}, {rrspBalance}, {tfsaBalance}, {nonRegBalance}, {cppMonthly}, {cppStartAge}, {cppAtRetirement}, {cppMonthlyToday}, {oasMonthly}, {oasStartAge}, {oasAtRetirement}, {oasMonthlyToday}, {pensionLine}, {depletionAge}, {portfolioDepleted}, {postDepletionIncome}, {postDepletionIncomeToday}, {postDepletionExpenses}, {postDepletionExpensesToday}, {yearsToRetirement}, {workingYearsWithWithdrawals}, {tfsaDepletedWhileWorking}' },
