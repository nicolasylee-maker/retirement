...
const PROMPT_FIELDS = [
  ...
  { key: 'prompt_dashboard', label: 'Dashboard Prompt', variables: '{currentAge}, {retirementAge}, {lifeExpectancy}, {inflationRatePct}, {monthlyExpenses}, {expReductionPct}, {expensesAtRetirement}, {expensesMonthlyToday}, {portfolioAtRetirement}, {portfolioAtRetirementToday}, {netWorthAtRetirement}, {annualIncome}, {annualTax}, {annualShortfall}, {shortfallMonthlyToday}, {sustainableMonthly}, {sustainableMonthlyToday}, {portfolioAtEnd}, {portfolioAtEndToday}, {rrspBalance}, {tfsaBalance}, {nonRegBalance}, {rrspContributionRoom}, {tfsaContributionRoom}, {cppMonthly}, {cppStartAge}, {cppAtRetirement}, {cppMonthlyToday}, {oasMonthly}, {oasStartAge}, {oasAtRetirement}, {oasMonthlyToday}, {pensionLine}, {depletionAge}, {portfolioDepleted}, {postDepletionIncome}, {postDepletionIncomeToday}, {postDepletionExpenses}, {postDepletionExpensesToday}, {yearsToRetirement}, {workingYearsWithWithdrawals}, {tfsaDepletedWhileWorking}, {primaryOasAtRetirement}, {primaryOasClawbackAmount}, {spouseOasAtRetirement}, {spouseOasClawbackAmount}, {primaryIncomeAtRetirement}, {spouseIncomeAtRetirement}, {isCouple}, {spouseAge}, {spouseRetirementAge}, {spouseEmploymentIncome}, {spouseRrspBalance}, {spouseTfsaBalance}, {spouseRrspContributionRoom}, {spouseTfsaContributionRoom}, {spouseCppMonthly}, {spouseCppStartAge}, {spouseOasMonthly}, {spouseOasStartAge}, {spousePensionIncome}' },
