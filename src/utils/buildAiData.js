...
export function buildDashboardAiData(scenario, projectionData) {
  ...
  return {
    ...
    rrspContributionRoom: scenario.rrspContributionRoom || 0,
    tfsaContributionRoom: scenario.tfsaContributionRoom || 0,
    ...
    ...(isCouple ? {
      ...
      spouseRrspContributionRoom: scenario.spouseRrspContributionRoom || 0,
      spouseTfsaContributionRoom: scenario.spouseTfsaContributionRoom || 0,
